...
USERNAME_EFFECTS = {"None", "Glow", "Gradient", "Shimmer", "Rainbow", "Fuzzy", "Shuffle", "Sparkle", "Glitch", "Pulse", "Wave", "Shadow", "Blue Sparkles", "Green Sparkles", "Pink Sparkles", "Red Sparkles", "White Sparkles", "Yellow Sparkles"}

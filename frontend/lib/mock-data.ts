...
export const mockProfile: ProfileConfig = {
  ...
  settings: {
    ...
    profileOpacity: 10, backgroundOpacity: 88, profileBlur: 24, profileRadius: 24, profileFrameOpacity: 100, profileGradient: true, showViews: true, showBadges: true, showSocials: true, showJoinDate: false, socialAlign: "center",
    cardAlign: "center", showProfileFrame: true, showAvatar: true, showAvatarBorder: true, showDisplayName: true, profileFrameScale: 100, profileFrameX: 0, profileFrameY: 0, layout: "Modern", avatarShape: "circle", bannerShape: "rounded", buttonStyle: "glass", profileFont: "Inter", profileFontScope: "all", fontSize: 16, letterSpacing: 0, bioTypewriter: false, bioTypeMs: 55, bioDeleteMs: 35, bioPauseMs: 1200, tabTitleAnimate: false, borderColor: "#ffffff", borderWidth: 1, cardTilt: false,
    entryScreen: true, entryText: "click to enter...", pageEnter: "Fade", clickSound: false, backgroundEffect: "Glow", usernameEffect: "Glow",

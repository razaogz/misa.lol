...
export const mockProfile: ProfileConfig = {
  ...
  settings: {
    ...
    cardAlign: "center", showProfileFrame: true, showAvatar: true, showAvatarBorder: true, showDisplayName: true, profileFrameScale: 100, profileFrameX: 0, profileFrameY: 0, layout: "Modern", avatarShape: "circle", bannerShape: "rounded", buttonStyle: "glass", profileFont: "Inter", fontSize: 16, letterSpacing: 0, bioTypewriter: false, bioTypeMs: 55, bioDeleteMs: 35, bioPauseMs: 1200, tabTitleAnimate: false, borderColor: "#ffffff", borderWidth: 1, cardTilt: false,

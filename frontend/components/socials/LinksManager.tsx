...
export function LinksManager() {
  ...
  return <main className="mx-auto min-h-screen max-w-[1250px] px-4 py-8 sm:px-8 sm:py-11 xl:px-12">
    ...
    <section className="mb-8 rounded-panel border border-white/[.07] bg-white/[.025] p-4 sm:p-6">
      <div className="mb-5 flex items-start gap-3"><span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#f00646]/10 text-[#fecdd3]"><Link2 size={18}/></span><div><h2 className="text-base font-semibold text-white">Link your social media profiles.</h2><p className="mt-1 text-xs text-zinc-500">Pick a social media to add to your profile.</p></div></div>
  ...
  return <Modal open={open} title={initial ? t("links.edit", { name: initial.platform }) : t("links.add")} description={t("links.modalDesc")} onClose={onClose}>
    <div className="max-h-[70vh] space-y-4 overflow-y-auto pr-1">
      ...
      <div>
        ...
        {prefix ? (
          <div className="flex h-11 overflow-hidden rounded-[10px] border border-white/[.08] bg-white/[.025] focus-within:border-[#f00646]/60 focus-within:ring-2 focus-within:ring-[#f00646]/10">
